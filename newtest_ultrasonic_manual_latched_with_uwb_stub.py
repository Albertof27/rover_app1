...
US_STOP_FRONT_M = 0.35
US_CAUTION_FRONT_M = 0.60
US_STOP_BACK_M = 0.30
US_SIDE_CLEAR_M = 0.45
US_AVOID_TURN_PWM = 320
US_AVOID_FWD_PWM = 170
US_AVOID_FAST_FWD_PWM = 300
...
def compute_motor_command(target, target_dist_m, frame_w):
    ...
    base = FAST_PWM if target_dist_m >= FAR_DIST_M else BASE_PWM
